...
import iog.psg.bcc.BccApiCodec.WalletAddressId
import iog.psg.bcc.BccApiMain.CmdLine
import iog.psg.bcc.TestWalletsConfig.baseUrl
import iog.psg.bcc.common.TestWalletFixture
import iog.psg.bcc.util.{ArgumentParser, Configure, Trace}
...
class BccApiMainITSpec extends AnyFlatSpec with Matchers with Configure with ScalaFutures with BeforeAndAfterAll with Eventually {
  ...
  ignore should "submit a transaction that was created and signed outside of bcc-wallet" in new TestWalletFixture(walletNum = 1){
  ...
  // keeping ignored, as it transfers all entropic from 1 to another
  //"The Cmd Line -migrateSophieWallet"
  ignore should "submit one or more transactions which transfers all funds from a Sophie wallet to a set of addresses" in {
  ...
  ignore should "calculate the cost" in new TestWalletFixture(walletNum = 1){
    ...
    //"The Cmd Line -getSophieWalletMigrationInfo"
    val results = runCmdLine(
      CmdLine.getSophieWalletMigrationInfo,
  ...
  "The Cmd Line --help" should "show possible commands" in {
    ...
    results.mkString("\n") shouldBe
      """This super simple tool allows developers to access a bcc wallet backend from the command line
        |
        |Usage:
        |
        | export CMDLINE='java -jar psg-bcc-wallet-api-assembly-<VER>.jar'
        ...
        | -migrateSophieWallet -walletId <walletId> -passphrase <passphrase> -addresses <addresses>
        | -getSophieWalletMigrationInfo -walletId <walletId>
  ...
  it should "show -baseUrl help" in {
    ...
    results.mkString("\n").stripMargin.trim shouldBe """ define different api url ( default : http://127.0.0.1:8090/v2/ )
                                                       ...
                                                       |
                                                       | Examples:
                                                       | $CMDLINE -baseUrl http://bcc-wallet-testnet.mydomain:8090/v2/ -wallets""".stripMargin.trim
  }

  it should "show -trace help" in {
    val results = runCmdLine(CmdLine.help, CmdLine.traceToFile)
    results.mkString("\n").stripMargin.trim shouldBe """ write logs into a defined file ( default file name: bcc-api.log )
                                                       |
  ...
  it should "show -netInfo help" in {
    ...
    results.mkString("\n").stripMargin.trim shouldBe """ Show network information
                                                       | [ https://The-Blockchain-Company.github.io/bcc-wallet/api/edge/#operation/getNetworkInformation ]
                                                       |
                                                       | Examples:
  ...
  it should "show -netClockInfo help" in {
    ...
    results.mkString("\n").stripMargin.trim shouldBe """ Show network clock information
                                                       | [ https://The-Blockchain-Company.github.io/bcc-wallet/api/edge/#operation/getNetworkClock ]
                                                       |
  ...
  it should "show -netParams help" in {
    ...
    results.mkString("\n").stripMargin.trim shouldBe """ Returns the set of network parameters for the current epoch.
                                                       | [ https://The-Blockchain-Company.github.io/bcc-wallet/api/edge/#operation/getNetworkParameters ]
                                                       |
                                                       | Examples:
  ...
  it should "show listWallets help" in {
    ...
    results.mkString("\n").stripMargin.trim shouldBe """ Return a list of known wallets, ordered from oldest to newest
                                                       | [ https://The-Blockchain-Company.github.io/bcc-wallet/api/edge/#operation/listWallets ]
                                                       |
                                                       | Examples:
  ...
  it should "show deleteWallet help" in {
    ...
    results.mkString("\n").stripMargin.trim shouldBe """ Delete wallet by id
                                                       | [ https://The-Blockchain-Company.github.io/bcc-wallet/api/edge/#operation/deleteWallet ]
                                                       |
  ...
  it should "show getWallet help" in {
    ...
    results.mkString("\n").stripMargin.trim shouldBe """ Get wallet by id
                                                       | [ https://The-Blockchain-Company.github.io/bcc-wallet/api/edge/#operation/getWallet ]
                                                       |
                                                       | Arguments: -walletId <walletId>
                                                       |
                                                       | Examples:
  ...
  it should "show updateName help" in {
    ...
    results.mkString("\n").stripMargin.trim shouldBe """ Update wallet's name
                                                       | [ https://The-Blockchain-Company.github.io/bcc-wallet/api/edge/#operation/putWallet ]
                                                       |
  ...
  it should "show createWallet help" in {
    ...
    results.mkString("\n").stripMargin.trim shouldBe """ Create new wallet ( mnemonic can be generated on: https://iancoleman.io/bip39/ )
                                                       | [ https://The-Blockchain-Company.github.io/bcc-wallet/api/edge/#operation/postWallet ]
                                                       |
  ...
  it should "show estimateFee help" in {
    ...
    results.mkString("\n").stripMargin.trim shouldBe """ Estimate fee for the transaction
                                                       | [ https://The-Blockchain-Company.github.io/bcc-wallet/api/edge/#operation/postTransactionFee ]
                                                       |
  ...
  it should "show estimateFeeStakePool help" in {
    ...
    results.mkString("\n").stripMargin.trim shouldBe """ Estimate fee for joining or leaving a stake pool
                                                       | [ https://The-Blockchain-Company.github.io/bcc-wallet/api/edge/#operation/getDelegationFee ]
                                                       |
                                                       | Arguments: -walletId <walletId>
                                                       |
                                                       | Examples:
  ...
  it should "show updatePassphrase help" in {
    ...
    results.mkString("\n").stripMargin.trim shouldBe """ Update passphrase
                                                       | [ https://The-Blockchain-Company.github.io/bcc-wallet/api/edge/#operation/putWalletPassphrase ]
                                                       |
  ...
  it should "show listWalletAddresses help" in {
    ...
    results.mkString("\n").stripMargin.trim shouldBe """ Return a list of known addresses, ordered from newest to oldest, state: used, unused
                                                       | [ https://The-Blockchain-Company.github.io/bcc-wallet/api/edge/#operation/listAddresses ]
                                                       |
  ...
  it should "show inspectWalletAddress help" in {
    ...
    results.mkString("\n").stripMargin.trim shouldBe """ Give useful information about the structure of a given address.
                                                       | [ https://The-Blockchain-Company.github.io/bcc-wallet/api/edge/#operation/inspectAddress ]
                                                       |
  ...
  it should "show listWalletTransactions help" in {
    ...
    results.mkString("\n").stripMargin.trim shouldBe """ Lists all incoming and outgoing wallet's transactions, dates in ISO_ZONED_DATE_TIME format, order: ascending, descending ( default )
                                                       | [ https://The-Blockchain-Company.github.io/bcc-wallet/api/edge/#operation/listTransactions ]
                                                       |
  ...
  it should "show createTx help" in {
    ...
    results.mkString("\n").stripMargin.trim shouldBe """ Create and send transaction from the wallet
                                                       | [ https://The-Blockchain-Company.github.io/bcc-wallet/api/edge/#operation/postTransaction ]
                                                       |
                                                       ...
                                                       | $CMDLINE -createTx -walletId 1234567890123456789012345678901234567890 -amount 20000 -address addr12345678901234567890123456789012345678901234567890123456789012345678901234567890 -passphrase Password12345! -metadata 0:0123456789012345678901234567890123456789012345678901234567890123:2:TESTINGBCCAPI
                                                       |""".stripMargin.trim
  }
  ...
  it should "show fundTx help" in {
    ...
    results.mkString("\n").stripMargin.trim shouldBe """ Select coins to cover the given set of payments
                                                       | [ https://The-Blockchain-Company.github.io/bcc-wallet/api/edge/#operation/selectCoins ]
                                                       |
                                                       | Arguments: -walletId <walletId> -amount <amount> -address <address>
                                                       |
                                                       | Examples:
  ...
  it should "show deleteTx help" in {
    ...
    results.mkString("\n").stripMargin.trim shouldBe """ Delete pending transaction by id
                                                       | [ https://The-Blockchain-Company.github.io/bcc-wallet/api/edge/#operation/deleteTransaction ]
                                                       |
  ...
  it should "show getTx help" in {
    ...
    results.mkString("\n").stripMargin.trim shouldBe """ Get transaction by id
                                                       | [ https://The-Blockchain-Company.github.io/bcc-wallet/api/edge/#operation/getTransaction ]
                                                       |
                                                       | Arguments: -walletId <walletId> -txId <txId>
                                                       |
                                                       | Examples:
  ...
  it should "show getUTxO help" in {
    ...
    results.mkString("\n").stripMargin.trim shouldBe
      """ Return the UTxOs distribution across the whole wallet, in the form of a histogram
        | [ https://The-Blockchain-Company.github.io/bcc-wallet/api/edge/#operation/getUTxOsStatistics ]
        |
        | Arguments: -walletId <walletId>
        |
        | Examples:
  ...
  it should "show postExternalTransaction help" in {
    ...
    results.mkString("\n").stripMargin.trim shouldBe
      """ Submits a transaction that was created and signed outside of bcc-wallet ( experimental )
        | [ https://The-Blockchain-Company.github.io/bcc-wallet/api/edge/#operation/postExternalTransaction ]
        |
  ...
  it should "show joinStakePool help" in {
    ...
    results.mkString("\n").stripMargin.trim shouldBe
      """ Delegate all (current and future) addresses from the given wallet to the given stake pool
        | [ https://The-Blockchain-Company.github.io/bcc-wallet/api/edge/#operation/joinStakePool ]
        |
  ...
  it should "show quitStakePool help" in {
    ...
    results.mkString("\n").stripMargin.trim shouldBe
      """ Stop delegating completely, the wallet's stake will become inactive
        | [ https://The-Blockchain-Company.github.io/bcc-wallet/api/edge/#operation/quitStakePool ]
        |
  ...
  it should "show stakePoolGetMaintenanceActions help" in {
    ...
    results.mkString("\n").stripMargin.trim shouldBe
      """ View maintenance actions
        | [ https://The-Blockchain-Company.github.io/bcc-wallet/api/edge/#operation/getMaintenanceActions ]
        |
  ...
  it should "show stakePoolPostMaintenanceActions help" in {
    ...
    results.mkString("\n").stripMargin.trim shouldBe
      """ Trigger maintenance actions
        | [ https://The-Blockchain-Company.github.io/bcc-wallet/api/edge/#operation/postMaintenanceAction ]
        |
